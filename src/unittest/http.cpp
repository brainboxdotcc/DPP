...
/** 
 * @brief Unit tests for HTTP client.
 * 1. Validate Host Name, Scheme and Port from URL string breakdown.
 * 2. Build a multipart content from json and send a POST request to discord server.
 * 3. Header validaion from a HTTP request to Github.com
 * 4. Header validation from a HTTP request to Google.com
 */

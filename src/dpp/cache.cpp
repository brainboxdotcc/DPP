...
/* Because other threads and systems may run for a short while after an event is
 * received, we don't immediately delete pointers when objects are replaced. We
 * put them into a queue, and periodically delete pointers in the queue. This
 * also rehashes unordered_maps to ensure they free their memory.
 */

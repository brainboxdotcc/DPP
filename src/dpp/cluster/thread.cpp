...
void cluster::forum_create(const std::string& forum_name, snowflake channel_id, message& forum_message, uint16_t auto_archive_duration, uint16_t rate_limit_per_user, std::vector<snowflake> applied_tags, command_completion_event_t callback)
{
	json j({
		{"name", forum_name},
		{"auto_archive_duration", auto_archive_duration},
		{"rate_limit_per_user", rate_limit_per_user},
		{"message", forum_message.build_json()},

 ...
 * Stage instances are like a conference facility, with moderators/speakers and
 * listeners.
 */
struct DPP_EXPORT stage_instance : public managed,
								   public json_interface<stage_instance> {
   ...
   */
  ~stage_instance() override = default;
...
using stage_instance_map = std::unordered_map<snowflake, stage_instance>;

...
/**
 * @brief The dpp::exception class derives from std::exception and supports some
 * other ways of passing in error details such as via std::string.
 */
...
/**
 * @brief Represents an error in logic, e.g. you asked the library to do
 * something the Discord API does not support
 * @note This is a stub for documentation purposes. For full information on
 * supported methods please see dpp::exception.
 */
...
/**
 * @brief Represents inability to parse data, usually caused by malformed JSON
 * or ETF
 * @note This is a stub for documentation purposes. For full information on
 * supported methods please see dpp::exception.
 */
...
/**
 * @brief Represents invalid access to dpp's cache or its members, which may or
 * may not exist.
 * @note This is a stub for documentation purposes. For full information on
 * supported methods please see dpp::exception.
 */
